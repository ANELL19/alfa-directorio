...
// 		 let increment = 0;
// 		 let message  = [];
// 		 console.log("esto es message", this.state.message)
...
// //  let contraseña = [];
// //  let  contraseñas=[]
// // for (var i=1; i<10;  i++) contraseña +=caracteres.charAt(Math.floor(Math.random()*caracteres.length)); 

// // if(i==this.state.contraseña)
...
// console.log("generador de contraseñas",generateRandomString(3));
